...
Assert-EqualHex $brokerIdentity.FileSha256 $manifest.brokerFileSha256 'Broker digest'
Assert-EqualHex $brokerIdentity.PublisherCertificateSha256 $manifest.brokerPublisherCertificateSha256 'Broker publisher'
