...
Latest M3 implementation evidence at this review point: `144e2b6`. M2 remains at `45ec3b3` in
...
| TD-002 | High | No WFP callout/Broker data plane exists. | “Strict” cannot guarantee proxy-or-block. | Signed callout, authenticated Broker, TCP/UDP v4/v6, DNS/QUIC VM evidence. | Partial through `aa45bc5`, `358f933`, `bd68b0a`, `4eb5721` and `144e2b6`: driver attestation, canonical WFP enumeration, atomic real-BFE filter/management-object transactions, bounded IOCTL policy upload and a fail-closed four-callout kernel source path exist; listener lease, relay, driver build and VM proof remain |
