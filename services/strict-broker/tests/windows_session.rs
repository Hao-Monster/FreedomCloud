...
fn packaged_command_process() -> (
    ...
    let package = StrictPackageManifest::parse(
        format!(
            r#"{{"protocol":1,"packageVersion":"session-test","driverBuildId":"{}","driverFileSha256":"{}","driverPublisherCertificateSha256":"{}","agentFileSha256":"{file_sha256}","agentPublisherCertificateSha256":"{}"}}"#,
            "12".repeat(16),
            "23".repeat(32),
            "34".repeat(32),
